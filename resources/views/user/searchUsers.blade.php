...
<head>
    ...
    <link rel="stylesheet" href="../proyectofinal-linkedbiz/resources/css/searchUsers.css">
    <link rel="icon" href="resources/views/logo-linkedbiz.png" type="image/png">
    <title>Buscar Usuarios - LinkedBiz</title>
</head>
<body>
                    ...
                    <div class="dropdown dropdown-hover">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <li class="dropdown-submenu">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="#" id="increaseTextButton">Aumentar texto</a></li>
                                    <li><a class="dropdown-item" href="#" id="decreaseTextButton">Disminuir texto</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="text" id="searchUserInput" class="form-control" placeholder="Introduce el nombre del usuario...">
                            <button class="btn btn-primary mt-2" id="searchUserButton">Buscar</button>
                        </div>
                    </div>
                </div>
